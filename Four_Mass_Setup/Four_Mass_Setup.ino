...
#define LIDAR1_ADDR               (0x62)
#define LIDAR2_ADDR               (0x42)
#define LIDAR3_ADDR               (0x52)
#define LIDAR4_ADDR               (0x22)
#define LIDAR1_OFFSET              38  // MEASURE AND CHANGE LATER
...
// Serial.println(lidar1.d);
  ...
  lidar2.interface.begin(0, true, LIDAR2_ADDR);
...
//    time4 = millis();
  ...
  //Serial.print("D2 = "); Serial.print(lidar2.d); Serial.print('\t'); Serial.print("T2 = "); Serial.print(time4 - time3); Serial.print('\n');
}
