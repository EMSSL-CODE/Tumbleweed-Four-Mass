...
savename    = 'crr_15.mat';  % standard other bits
...
Crr0        = 0.0035;           % rolling resistance coefficient 
% use_ode     = 'ode45';
...
massfunct   = 'revB';       % revA = cone angles, revB = kinematic simulation, revC = kinematics + d/dt
